   ...
   <!-- <div class="container-fluid px-5 d-none border-bottom d-lg-block">
    ...
    <div class="container-fluid page-header py-5">
        ...
        <ol class="breadcrumb justify-content-center mb-0 wow fadeInUp" data-wow-delay="0.3s">
            <li class="breadcrumb-item text-lg" ><a href="#shop-cards" class="btn btn-secondary rounded-pill align-self-center py-2 px-4">Shop Now</a></li>
        </ol>
    </div>
                    ...
                    <a href="#">
                        <div class="bg-primary rounded position-relative">
                            ...
                            <div class="position-absolute top-0 start-0 w-100 h-100 d-flex flex-column justify-content-center rounded p-4"
                                ...
                                <a href="#shop-cards" class="btn btn-primary rounded-pill align-self-start py-2 px-4">Shop Now</a>
                            </div>
                        </div>
                    </a>
                </div>
                    ...
                    <a href="#">
                        <div class="text-center bg-primary rounded position-relative">
                            ...
                            <div class="position-absolute top-0 start-0 w-100 h-100 d-flex flex-column justify-content-center rounded p-4"
                                ...
                                <a href="#shop-cards" class="btn btn-secondary rounded-pill align-self-center py-2 px-4">Shop
                                    Now</a>
                            </div>
                        </div>
                    </a>
